...
for i in range(1, sheet.nrows):
    ...
    if resident_i["building"] in ["TOW", "HAN", "MTH", "PER", "GRY", "HAY"]:
        resident_i["area"] = "Towers, Hanson, Matheson, Perry, I-House"
    ...
    a1_as_datetime = datetime.datetime(
        *xlrd.xldate_as_tuple(sheet.cell_value(i, 7), wb.datemode))
